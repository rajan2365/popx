...
const hashPassword = async (password) => {
  ...
  // Creates a TextEncoder object to convert the password (a string) into a Uint8Array (a typed array of bytes).
...
// SHA-256 is widely used and secure for hashing purposes.
// Web Crypto API is native to the browser and safe (unlike custom JS libraries that can be less secure).
